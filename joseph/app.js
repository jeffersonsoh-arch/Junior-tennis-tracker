...
function schedulePersist(){
  ...
  persistTimer=setTimeout(function(){
    ...
    saveRemoteState(authClient, authUserId, "joseph", STORAGE_KEY, state)
...
function boot(client, session){
  ...
  document.getElementById("app").innerHTML = '<div class="app-loading">Loading Joseph’s progress…</div>';
  loadRemoteState(client, authUserId, "joseph", STORAGE_KEY, DEFAULT_STATE)
